...
- The .agent/USER.md file is where the agent can communicate to the user about design choices. This is only for medium-large design changes or configuration changes. Decisions or suggestions about the project should be recorded here. If you have a suggestion within the general scope of the project, **execute it without asking** and record the decision in this file. If the suggestion is far beyond the scope of the project, make a suggestion and continue.
- Keep preambles to a single declarative sentence ("I'm scanning the repo and then drafting a minimal fix.").
